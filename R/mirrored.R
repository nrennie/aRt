...
#' @param col_palette Vector of colours. Default `c("#420f75", "#7640a9", "#ad72d6", "#e7a8fb", "#f5f5f5", "#f8b150", "#c17d17", "#8a4d00", "#552000")`.
...
mirrored <- function(n = 15,
                     w = 4,
                     col_palette = c("#420f75", "#7640a9", "#ad72d6", "#e7a8fb", "#f5f5f5", "#f8b150", "#c17d17", "#8a4d00", "#552000"),
                     s = 1234) {
  w <- floor(w)
  if (w < 2) {
