...
bullseye <- function(main_col = "black", bg_col = "white", s = 1234) {
  ...
  # make plot layers
  p1 <- ggplot2::ggplot() +
    ggplot2::geom_bar(data = df1, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
                      stat = "identity", width = 1, fill = ggplot2::alpha(main_col, 0.3)) +
    ggplot2::geom_bar(data = df2, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
  ...
  p2 <- ggplot2::ggplot() +
    ggplot2::geom_bar(data = df3, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
                      stat = "identity", width = 1, fill = ggplot2::alpha(main_col, 0.3)) +
    ggplot2::geom_bar(data = df4, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
                      stat = "identity", width = 0.2, fill = ggplot2::alpha(main_col, 0.3)) +
    ggplot2::ylim(-30, 100) +
  ...
  p3 <- ggplot2::ggplot() +
    ggplot2::geom_bar(data = df5, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
             stat = "identity", width = 1, fill = ggplot2::alpha(main_col, 0.3)) +
    ggplot2::geom_bar(data = df6, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
             stat = "identity", width = 0.2, fill = ggplot2::alpha(main_col, 0.3)) +
    ggplot2::ylim(-40, 100) +
  ...
  p4 <- ggplot2::ggplot() +
    ggplot2::geom_bar(data = df7, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
                      stat = "identity", width = 1, fill = ggplot2::alpha(main_col, 0.3)) +
    ggplot2::geom_bar(data = df8, mapping = ggplot2::aes(x = as.factor(.data$id), y = .data$value),
