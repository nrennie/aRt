...
#' @param col_palette Vector of colours. Default `"#D2FBD4" "#A5DBC2" "#7BBCB0" "#559C9E" "#3A7C89" "#235D72" "#123F5A"`.
...
boxes <- function(n = 100,
                  perc = 0.1,
                  col_palette = c("#D2FBD4", "#A5DBC2", "#7BBCB0", "#559C9E", "#3A7C89", "#235D72", "#123F5A"),
                  bg_col = "black",
                  s = 1234) {
